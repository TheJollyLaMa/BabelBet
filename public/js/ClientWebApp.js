...
app.config([
  ...
  function($routeProvider) {
    ...
    .when("/CounterOffer", {controller: "ChallengeController",templateUrl: "Challenge/counter_offer.html"})
    .when("/Accept", {controller: "ChallengeController",templateUrl: "Challenge/accept_offer.html"})
