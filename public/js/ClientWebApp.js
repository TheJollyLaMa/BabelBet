...
app.config([
  ...
  function($routeProvider) {
    ...
    .when("/CounterOffer/:email1/:email2/:eth_account1/:duo1_username/:duo1_password/:duo2_username/:proposal_type/:proposal_days/:proposal_amount", {controller: "ChallengeController",templateUrl: "Challenge/counter_offer.html"})
    .when("/Accept/:email1/:email2/:eth_account1/:duo1_username/:duo1_password/:duo2_username/:proposal_type/:proposal_days/:proposal_amount", {controller: "ChallengeController",templateUrl: "Challenge/accept_offer.html"})
